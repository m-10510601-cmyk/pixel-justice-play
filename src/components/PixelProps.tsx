    ...
    <div className="absolute inset-0 z-[3] pointer-events-none" aria-hidden="true">
      ...
      <div className="absolute" style={{ top: "10%", right: "7%", width: 40, height: 22 }}>
        ...
        <div
          ...
          style={{ top: 6, left: 10, width: 3, height: 2, background: "hsl(48 100% 85%)" }}
        />
      </div>
      ...
      <div className="absolute" style={{ top: "28%", right: "5%", width: 22, height: 38 }}>
        ...
        >
          <span
            ...
            style={{ color: "hsl(0 0% 0%)", fontSize: 6, lineHeight: 1 }}
          >
            12
          </span>
          {/* hands */}
        ...
        {/* pendulum */}
        <div
          className="absolute pendulum-swing"
          style={{ top: 22, left: "50%", width: 1, height: 14, background: "hsl(0 0% 30%)" }}
        >
          <div
      ...
      <div
        ...
        style={{
          ...
          boxShadow: "0 0 12px hsl(48 100% 60%), inset 0 0 0 1px hsl(0 0% 0%)",
        }}
      />
      <div
        className="absolute lamp-flicker"
