...
const STORY: Step[] = [
...

  {
    ...
    text:
      "Johor Bahru, 18 Feb 2017, 3:20 a.m. Eight teenagers on modified brakeless 'basikal lajak' were struck on a public road by driver Sam Ke Ting (22). All eight died. Speed limit 70 km/h; her measured speed ~44 km/h.\n\nVerdict path: Magistrate acquitted (2019) → High Court convicted, 6 years' jail + RM6,000 (2021) → Court of Appeal upheld (2022) → Federal Court acquitted (2023): prosecution failed to prove reckless driving beyond reasonable doubt.\n\nThis chapter mirrors that same tension — driver duty, victim conduct, and structural failure all share the blame.",
  },
];
