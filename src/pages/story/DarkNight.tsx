...
const STORY: Step[] = [
  ...
  {
    kind: "insight",
    title: "📜 Insight · Inspired by the Basikal Lajak Case",
    text:
      "• THE REAL CASE\nOn 18 February 2017 around 3:20 a.m. in Johor Bahru, eight teenagers aged 13–17 were riding modified brakeless 'basikal lajak' down a public road when a 22-year-old driver, Sam Ke Ting, struck them in her Proton. Eight died at the scene. The road was poorly lit, the speed limit was 70 km/h, and forensic analysis put her speed at roughly 44–45 km/h.\n\n• THE LEGAL JOURNEY\n2019 — Magistrates' Court acquitted her.\n2021 — High Court reversed on appeal: 6 years' jail + RM6,000 fine for reckless driving causing death.\n2022 — Court of Appeal upheld the conviction.\n2023 — Federal Court finally quashed the conviction. Held: the prosecution failed to prove reckless or dangerous driving beyond reasonable doubt.\n\n• WHY THIS CHAPTER LOOKS FAMILIAR\nThe core tension you just judged — youth culpability vs. driver duty of care vs. structural failure (parents, enforcement, road design, the upload economy) — is the exact legal terrain of Basikal Lajak. Q9a (allocation), Q9b (degree), and Q9c (multi-party) are modelled on the very questions the Federal Court had to weigh.",
  },

  {
    kind: "insight",
    title: "⚖ Insight · Legal Doctrines Unpacked",
    text:
      "• BEYOND REASONABLE DOUBT\nIn criminal cases the prosecution must prove every element to a near-certainty. The Federal Court acquitted Sam Ke Ting because that bar was not met — driving within the limit, on an unlit road, against victims who were unlawfully on the carriageway, did not unambiguously prove 'reckless or dangerous'.\n\n• MENS REA (GUILTY MIND)\nReckless driving causing death (Road Transport Act 1987, ss. 41/42) needs more than an accident. The driver must have shown gross negligence — a serious departure from what a careful driver would do. Bad outcomes alone do not create mens rea.\n\n• CONTRIBUTORY NEGLIGENCE\nWhen victims themselves create the danger — no licence, no lights, modified bikes, 3 a.m. on a public road — their conduct cuts down the driver's causal share. This is the legal engine behind the 'partial liability' choice in Q9b.\n\n• MULTI-PARTY RESPONSIBILITY\nA single defendant rarely tells the whole story. Parental supervision, local enforcement, road lighting standards, and social-media reward loops that glamorise night-runs all share the chain of causation. That is why the hidden top-score answer in Q9c names all four.\n\n• THE REAL LESSON\nThe law cannot only ask 'who goes to prison'. It must also ask 'how do we stop the next one'. After Basikal Lajak, several Malaysian states banned the sale of modified lajak, expanded school road-safety programmes, and improved street lighting on identified blackspots. That is the policy verdict the courtroom verdict alone could never deliver.",
  },
];
