          ...
          <>
            ...
            <div className="bg-primary/15 border-2 border-primary p-3">
              ...
              <p className="text-sm mt-2">
                The mask of authority works because we are trained to obey it. The scam is industrial: a script for the call, a costume for the door, a pipeline for the cash. Stopping the runner is not stopping the operation.
              </p>
