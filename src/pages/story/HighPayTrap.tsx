    ...
    <GameFrame bgImage={bg}>
      <header className="pt-5 px-5 flex items-center gap-3">
        ...
        <h1 className="pixel text-glow text-xs sm:text-sm text-primary flex-1 text-center pr-12">
          <T>CHAPTER 8 · THE HIGH-PAY TRAP</T>
        </h1>
      </header>
      ...
      <main className="flex-1 px-5 py-4 overflow-y-auto space-y-4">
        ...
        {done && ending && (
          <>
            ...
            <StarReward slug="high-pay-trap" story={STORY} answers={answers as Record<string, string>} ending={ending} />

            <div className="bg-primary/15 border-2 border-primary p-3">
              <div className="pixel text-[10px] text-primary">📚 What This Teaches</div>
              <p className="text-sm mt-2">
                <T>Trafficking does not look like kidnapping. It looks like a job ad, a smile, a contract you'll sign “on arrival,” and a passport in someone else's safe. Lies + debt + document seizure = a cage without bars.</T>
              </p>
